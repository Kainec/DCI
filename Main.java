...
class Main {
 ...
 //   Перевіпяємо чи є місто що ввів користувач у списку
    ...
    if(!isCorrectCity){
      System.out.println("Такого міста не має в списку! Введіть інше місто");
      continue;
    }  

//Перевіпяємо чи з потрібної букви ми вводимо слово
